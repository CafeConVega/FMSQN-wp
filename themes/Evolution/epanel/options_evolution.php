	...
	array( "name" => "wrap-general",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Color Scheme",
				   ...
				   "options" => array("Default", "Blue", "Green", "Red") ),
		...
		array( "name" => "general-2",
			...
			array( "name" => "Display Homepage Quote",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "This controls the quote that appears on the homepage."),

			array( "name" => 'Display Recent Work Section',
                   "id" => $shortname."_display_recentwork_section",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => 'Here you can choose to display the Recent Work Section on the homepage. '
			),
			...
			array( "name" => "Quote Text",
                   ...
                   "std" => 'Lorem ipsum dolor sit amet consectetur adipiscing elit donec facilisis ultri libero ac tempus donec dictum magna sit amet consectetur',
                   "type" => "text",
			...
			array( "name" => "Recent Work Section description",
                   ...
                   "std" => "Pellentesque adipiscing odio eu neque gravida vehicula. Ut ultricies diam vel est convallis non auctor dui scelerisque. Quisque at erat sem.",
                   "type" => "text",
				   "desc" => "Recent Work Section description"
			),

			array( "name" => "Number of Posts in Recent Work Section",
                   "id" => $shortname."_posts_work_num",
                   "std" => "3",
                   "type" => "text",
                   "validation_type" => "number",
			...
			array( "name" => 'Display About Page',
                   "id" => $shortname."_display_about_page",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => 'Here you can choose to display the About Section on the homepage. '
			),

			array( "name" => 'Display Recent Blog Posts',
                   "id" => $shortname."_display_recent_blog_posts",
                   "type" => "checkbox2",
                   "std" => "on",
                   "desc" => 'Here you can choose to display the Recent Blog Posts section. '
			),
			...
			array( "name" => "About Page",
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => "Here you can choose the page you would like to display in the About Section on the homepage. ",
				   "options" => $site_pages,
				   'et_array_for' => 'pages'),
			...
			array( "name" => 'Recent Blog Posts Section Category',
				   ...
				   "std" => "",
				   "type" => "select",
				   "desc" => 'Here you can choose the category you would like to display in the Blog Posts Section on the homepage. ',
				   "options" => $site_cats,
				   'et_array_for' => 'categories' ),

			array( "name" => "Number of Posts in Recent Blog Posts Section",
                   "id" => $shortname."_posts_blog_num",
                   "std" => "3",
                   "type" => "text",
                   "validation_type" => "number",
				   "desc" => "Here you can choose the number of posts you would like to display in the Recent Blog Posts Section on the homepage. "
			),
		...
		array( "name" => "general-3",
			...
			array( "name" => "Display Featured Slider",
                   ...
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "You can choose whether or not to display the Featured Articles section on the homepage. If you don't want to utilize this feature simply disable this option."),
			...
			array( "name" => "Slider Animation",
				   ...
				   "type" => "select",
				   "std" => "fade",
				   "desc" => "You can select Slider Animation here.",
